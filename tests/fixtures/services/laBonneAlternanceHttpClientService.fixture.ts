...
export function anAlternanceListAxiosResponse(): AxiosResponse {
  return anAxiosResponse(
    anAlternanceListResponse(),
  );
}

export function anAlternanceListResponse() {
  return {
    matchas: {
      results: [
        {
...
export function anApprentiBoucherFromPoleEmploiAxiosResponse(): AxiosResponse {
  return anAxiosResponse(
    {
      peJobs: [{
        capacity: null,
...
export function anApprentiBoucherFromMatchaAxiosResponse(): AxiosResponse {
  return anAxiosResponse(
    {
      matchas:  [{
        capacity: null,
