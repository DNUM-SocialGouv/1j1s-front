...
describe('strapi cms repository', () => {
  ...
  describe('getPageFooter', () => {
    it('retourne le contenu venant de strapi par rapport au type de contenu', async () => {
      strapiHttpClientService = aStrapiHttpClientService();
      strapiCmsRepository = new StrapiCmsRepository(strapiHttpClientService);
      ...
      expect(strapiHttpClientService.get).toHaveBeenCalledWith('politique-de-confidentialite', mapPageFooter);
    });
  });
