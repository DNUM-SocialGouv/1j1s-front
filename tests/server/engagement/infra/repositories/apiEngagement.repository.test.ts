  ...
  describe('searchMissionEngagement', () => {
    describe('quand l\'api engagement répond avec une 200', () => {
      it('recherche les missions', async () => {
        ...
        expect(engagementHttpClientService.get).toHaveBeenCalledWith('mission/search?domain=sante&distance=10km&from=1&lat=2.3522&lon=48.8566&publisher=a-publisher-id&size=30');
      });
    });
