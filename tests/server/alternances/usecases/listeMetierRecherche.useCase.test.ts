import { AlternanceRepository } from "../../../../src/server/alternances/domain/alternance.repository";
import { ListeMetierRechercheUseCase } from "../../../../src/server/alternances/usecases/listeMetierRecherche.useCase";
