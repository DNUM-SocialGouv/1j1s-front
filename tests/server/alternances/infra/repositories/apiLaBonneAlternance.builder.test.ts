...
describe('buildParamètresRechercheAlternance', () => {
  describe('quand on cherche des codeRomes', () => {
    it('quand on cherche des codeRomes', async () => {
      const result = buildParamètresRechercheLaBonneAlternance({ codeRomeList: ['D1103', 'D1101', 'H2101'] });
  ...
  it('quand on cherche avec un lieu', async () => {
    const result = buildParamètresRechercheLaBonneAlternance({ code: '75001', codeRomeList: ['D1103','D1101','H2101'], latitude:'48.08', longitude:'2.01', radius: '30' });
  ...
  it('quand on cherche avec un lieu et un rayon', async () => {
    const result = buildParamètresRechercheLaBonneAlternance({
      code: '75035',
