...
import styles from '~/client/components/features/Immersions/ReferencesEntreprises/ReferencerEntreprises.module.scss';
		...
		<div className={styles.referencer}>
			<Container className={styles.container}>
				...
				<ul>
					...
					<li>D’initier un parcours d’embauche pour leur permettre d’accéder à un emploi ou dans le cadre d’une
						reconversion
					</li>
				</ul>
				<Link
