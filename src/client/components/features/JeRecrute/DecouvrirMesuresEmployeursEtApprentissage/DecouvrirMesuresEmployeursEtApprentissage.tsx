			...
			<Container className={styles.sectionBox}>
				<div className={styles.sectionBoxContainer}>
					<span className={ styles.sectionBoxContainerText }>
						...
						<Link href="/mesures-employeurs" appearance="asSecondaryButton">Découvrir les mesures employeurs</Link>
					</span>
				</div>
				<div className={styles.sectionBoxContainer}>
					<span className={ styles.sectionBoxContainerText }>
						...
						<Link href="/apprentissage-entreprises" appearance="asSecondaryButton">Découvrir l’apprentissage</Link>
					</span>
				</div>
			</Container>
		</section>
