...
import {
	ToutSavoirSurApprentissage,
} from '~/client/components/features/CampagneApprentissage/CampagneApprentissageEntreprises/ToutSavoirSurApprentissage/ToutSavoirSurApprentissage';
