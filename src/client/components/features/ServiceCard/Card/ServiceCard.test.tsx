...
describe('ServiceCard', () => {
	...
	it('si une alternative textuelle au logo est fournie, le logo l‘utilise', () => {
		render(<ServiceCard link="/par-ici" linkLabel="Par là" logo="/image.jpg" logoAlt="Service Plus, le service des pros"
			title="Mon nouveau service" titleAs="h1">Wow ce service est incroyable</ServiceCard>);
