...
export default function JeDonneMonAvis() {
	return <Container className={styles.jeDonneMonAvis}>
		...
		<LinkDeprecated className={styles.lien} href="https://jedonnemonavis.numerique.gouv.fr/Demarches/3639?&view-mode=formulaire-avis&nd_source=button&key=8ff5d31556dab600903ec418c6079a86" title="Je donne mon avis - nouvelle fenêtre">
