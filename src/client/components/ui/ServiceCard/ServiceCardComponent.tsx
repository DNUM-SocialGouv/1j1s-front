import { ButtonGroup, Icon, Title } from '@dataesr/react-dsfr';
...
function ServiceCard(props: ServiceCardProps) {
  ...
  return (
    <Link href={link}>
      <a data-testid="RésultatServiceCard">
        <div className={styles.card}>
          ...
          <div className={styles.cardBody}>
            ...
            <p>{text}</p>
            <ButtonGroup className="fr-link" size="md" align="right">
              <Icon name="ri-arrow-right-line" size="1x" iconPosition="right" />
            </ButtonGroup>
          </div>
        </div>
      </a>
