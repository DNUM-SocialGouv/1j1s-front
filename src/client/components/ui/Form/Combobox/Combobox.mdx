...
Deux stratégies sont déjà définies :
- `Combobox.filterOnValueAndLabel()` est la valeur par défaut et filtre sur la valeur de l'option ainsi que son libelle
- `Combobox.noFilter()` ne filtre pas du tout les options

<Canvas of={stories.filterStrategy} />
