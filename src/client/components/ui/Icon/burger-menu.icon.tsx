...
export function BurgerMenuIcon({ color = 'currentColor', className, isDecorative = true }: SvgProps) {
  return (
    <svg width="24" height="24" className={classNames(className, styles.size)} viewBox="0 0 25 24" fill={color} xmlns="http://www.w3.org/2000/svg" aria-hidden={isDecorative}>
