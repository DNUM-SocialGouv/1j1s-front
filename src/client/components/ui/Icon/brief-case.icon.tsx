...
export function BriefCaseIcon({ color = 'currentColor', className, ...rest }: SvgProps) {
	return (
		<svg className={classNames(className)} width="52" height="52" viewBox="0 0 52 52" fill={color} xmlns="http://www.w3.org/2000/svg" {...rest}>
