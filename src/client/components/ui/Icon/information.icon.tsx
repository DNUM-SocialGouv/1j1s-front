...
export function InformationIcon({ color = 'currentColor', className, ...rest }: SvgProps) {
	return (
		<svg width="20" height="20" className={classNames(className, styles.size)} viewBox="0 0 24 24" fill={color} xmlns="http://www.w3.org/2000/svg" {...rest}>
