...
export function AngleDownIcon({ color = 'currentColor', className, isDecorative = true }: SvgProps) {
  return (
    <svg width="24" height="25" className={classNames(className, styles.size)} viewBox="0 0 24 25" fill={color} xmlns="http://www.w3.org/2000/svg" aria-hidden={isDecorative}>
