...
const offresNav = (): NavigationItemWithChildren => ({
	children: [
		...
		...(process.env.NEXT_PUBLIC_STAGES_SECONDE_LIEN_FEATURE === '1' ? [{ label: <>Stage de 2de <Icon className={styles.externalIcon} name="external-redirection"/></>, link: process.env.NEXT_PUBLIC_STAGES_SECONDE_URL || '#' }] : []),
