...
export const niveauEtudesEures = [
	{
		...
		valeur: EURES_EDUCATION_LEVEL_CODES_TYPE.ENSEIGNEMENT_PRESCOLAIRE,
	},
	{
		libellé: 'Enseignement primaire',
		valeur: EURES_EDUCATION_LEVEL_CODES_TYPE.ENSEIGNEMENT_PRIMAIRE,
	},
	{
		libellé: 'Enseignement secondaire inférieur',
		valeur: EURES_EDUCATION_LEVEL_CODES_TYPE.ENSEIGNEMENT_SECONDAIRE_INFERIEUR,
	},
	{
		libellé: 'Enseignement secondaire supérieur',
		valeur: EURES_EDUCATION_LEVEL_CODES_TYPE.ENSEIGNEMENT_SECONDAIRE_SUPERIEUR,
	},
	{
		libellé: 'Enseignement post-secondaire non supérieur',
		valeur: EURES_EDUCATION_LEVEL_CODES_TYPE.ENSEIGNEMENT_POST_SECONDAIRE_NON_SUPERIEUR,
	},
	{
		libellé: 'Enseignement supérieur de cycle court',
		valeur: EURES_EDUCATION_LEVEL_CODES_TYPE.ENSEIGNEMENT_SUPERIEUR_CYCLE_COURT,
	},
	{
		libellé: 'Niveau licence (Bachelor) ou équivalent',
		valeur: EURES_EDUCATION_LEVEL_CODES_TYPE.NIVEAU_LICENCE_OU_EQUIVALENT,
	},
	{
		libellé: 'Niveau maîtrise (Master) ou équivalent',
		valeur: EURES_EDUCATION_LEVEL_CODES_TYPE.NIVEAU_MAITRISE_OU_EQUIVALENT,
	},
	{
		libellé: 'Niveau doctorat ou équivalent',
		valeur: EURES_EDUCATION_LEVEL_CODES_TYPE.NIVEAU_DOCTORAT_OU_EQUIVALENT,
	},
	{
		libellé: 'Autre',
		valeur: EURES_EDUCATION_LEVEL_CODES_TYPE.AUTRE,
	},
] as const;
