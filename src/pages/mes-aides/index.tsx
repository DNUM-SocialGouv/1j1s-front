  ...
  return (
    <>
      ...
      <main id="contenu" className={styles.container}>
        <Container className={styles.bannière}>
          <div className={styles.bannièreWrapper}>
            ...
            <LinkAsButton
              ...
              target="_blank"
              className={styles.bannièreCommencerSimulation}
            >
              Je commence la simulation
            </LinkAsButton>
          </div>
          <div className={styles.bannièreIllustration}>
