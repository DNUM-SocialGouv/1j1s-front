...
export async function rechercherStage3emeEt2ndHandler(req: NextApiRequest, res: NextApiResponse<ResultatRechercheStage3emeEt2nd | ErrorHttpResponse>) {
...
export default withMonitoring(withValidation({ query: stage3emeRechercheQuerySchema }, rechercherStage3emeEt2ndHandler));
