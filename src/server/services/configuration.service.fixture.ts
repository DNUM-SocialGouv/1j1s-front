...
export class ConfigurationServiceFixture implements ConfigurationService {
	...
	constructor(overrides?: Partial<EnvironmentVariables>) {
		this.variables = {
			...
			API_FRANCE_TRAVAIL_OFFRES_URL: 'https://api.pole-emploi.io/partenaire/offresdemploi/v2/offres',
			API_FRANCE_TRAVAIL_REFERENTIEL_URL: 'https://api.pole-emploi.io/partenaire/offresdemploi/v2/referentiel',
			...
			FRANCE_TRAVAIL_CONNECT_URL: 'https://entreprise.pole-emploi.fr',
			IS_REVIEW_APP: false,
