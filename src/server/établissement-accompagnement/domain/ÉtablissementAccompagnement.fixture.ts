...
export function anÉtablissementAccompagnementList(): ÉtablissementAccompagnement[] {
  return [
    {
      adresse: undefined,
...
export function anotherÉtablissementAccompagnementList(): ÉtablissementAccompagnement[] {
  return [
    {
...
export function aÉtablissementMissionLocaleList(): ÉtablissementAccompagnement[] {
  return [
    {
