...
} from '~/server/alternances/infra/repositories/responses/peJobsResponse.type';
...
export function mapContact(contact: MatchasContactResponse | PeJobsContactResponse | undefined): Alternance.Contact | undefined {
...
export function mapRésultatRechercheAlternance(response: AlternanceDetailResponse): RésultatRechercheAlternance {
