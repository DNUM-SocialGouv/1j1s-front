...
const aLogInformationApiGeo = aLogInformation({
	apiSource: 'API Geo',
	contexte: 'get localisation', message: '[API Geo] impossible de récupérer une ressource',
});
	...
	describe('getCommuneListByNom', () => {
		...
		describe('quand l’api renvoie une erreur', () => {
			it('log les informations de l’erreur et retourne une erreur métier associée', async () => {
				...
				expect(errorManagementService.handleFailureError).toHaveBeenCalledWith(errorHttp, aLogInformationApiGeo);
