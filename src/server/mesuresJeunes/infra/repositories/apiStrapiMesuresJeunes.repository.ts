...
export class ApiStrapiMesuresJeunesRepository implements MesuresJeunesRepository {
  ...
  async getMesuresJeunes(): Promise<Either<MesuresJeunes>> {
    ...
    return await this.strapiHttpClientService.get<Strapi.MesuresJeunesContentType, MesuresJeunes>('mesure-jeune?populate[vieProfessionnelle][populate]=*&populate[orienterFormer][populate]=*&populate[accompagnement][populate]=*&populate[aidesFinancieres][populate]=*', mapMesuresJeunes);
  }
}
