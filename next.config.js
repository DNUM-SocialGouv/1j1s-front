...
const TRUSTED_SOURCES = '*.fabrique.social.gouv.fr *.lon.meilisearch.io/indexes/offre-de-stage/search 1j1s-front.osc-fr1.scalingo.io/api/* *.1jeune1solution.gouv.fr';
