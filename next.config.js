...
const sentryModuleExports = {
	disableClientWebpackPlugin: false, //todo: à remettre comme avant avant de merger la RA
	disableServerWebpackPlugin: false, //todo: à remettre comme avant avant de merger la RA
	hideSourceMaps: true,
	silent: true,
