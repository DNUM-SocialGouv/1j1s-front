...
const contentSecurityPolicy = `
  default-src 'self' ${TRUSTED_SOURCES} https://*.linkedin.com;
  script-src 'self' ${ANALYTICS_SOURCES} https://*.adform.net https://*.zemanta.com https://*.licdn.com;
  img-src 'self' *.google.com data: ${STRAPI_MEDIA_HOST} ${ANALYTICS_SOURCES} img.youtube.com jedonnemonavis.numerique.gouv.fr https://*.linkedin.com;
