...
const contentSecurityPolicy = `
  default-src 'self' ${TRUSTED_SOURCES} https://insight.adsrvr.org/track/ https://www.google.com https://*.doubleclick.net/;
  script-src 'self' ${ANALYTICS_SOURCES} https://*.adform.net https://js-tag.zemanta.com/zcpt.js https://js.adsrvr.org/up_loader.1.1.0.js https://www.googletagmanager.com;
  ...
  frame-src 'self' *.apprentissage.beta.gouv.fr immersion-facile.beta.gouv.fr deposer-offre.www.1jeune1solution.gouv.fr *.youtube-nocookie.com simulateur-alternance.1jeune1solution.gouv.fr https://*.adform.net mes-aides.francetravail.fr https://insight.adsrvr.org/ https://*.doubleclick.net/;
  form-action 'self';
  base-uri 'none';
`;
